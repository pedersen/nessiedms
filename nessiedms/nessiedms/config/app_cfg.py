# -*- coding: utf-8 -*-
"""
Global configuration file for TG2-specific settings in nessiedms.
...
from nessiedms.lib import app_globals, helpers 
...
base_config.DBSession = nessiedms.model.DBSession
